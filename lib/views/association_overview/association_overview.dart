                  ...
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () {
                            /**
                             * HO DOVUTO AGGIUNGERE IL PARAMETRO IS REAL ASSOCIATION ESTERNAMENTE 
                             * IN QUANTO IL MODELLO UTILITY LO RESTITUISCE COME NULL.
                             */
                            Navigator.of(context).pushNamed(
                                Routes.utilityOverView,
                                arguments: AssociationWrapper(
                                    association: params,
                                    isReal: params?.isRealAssociation,
                                    index: index,
                                    isEdit: true));
                          },
                          child: Padding(
